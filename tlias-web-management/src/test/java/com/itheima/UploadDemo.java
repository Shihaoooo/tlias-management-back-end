...
public class UploadDemo {
    ...
    public static void main(String[] args) throws Exception {
        InputStream input = new FileInputStream("/Users/zhoushihao/IdeaProjects/web-ai-project02/tlias-web-management/src/main/resources/templates/tmp_headIcon.png");

        String https = new UploadDemo().upload("tmp_headIcon.png",input);
